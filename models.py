...
class Customer(db.Model):
    ...
    # Relationship
    prediction = db.relationship('Prediction', backref='customer', uselist=False, cascade='all, delete-orphan')
...
class Prediction(db.Model):
    ...
    will_churn = db.Column(db.Integer)  # 0 or 1
    churn_probability = db.Column(db.Float)  # 0-100
